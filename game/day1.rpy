    ...
    menu:
        "Отправить анализ рыбы и воды (300$)":
            if budget >= 300:
                ...
                b "У вас не хватает средств на анализы."
        "Порекомендовать фильтр для воды (50$)":
            if budget >= 50:
                ...
                b "У вас не хватает средств даже на фильтр."
        "Пожать плечами":
            $ rating -= 2
    ...
    menu:
        ...
        "Организовать подвоз чистой воды (3000$)":
            if budget >= 3000:
                ...
                m "У вас не хватает средств на подвоз воды."
...
label case_factory_worker:
    ...
    g "Спасибо за честность. Мы разберёмся."
    ...
    menu:
        "Обязать установить очистку (5000$ субсидия)":
            if budget >= 5000:
                ...
                f "У вас не хватает средств на субсидию."
