...
label dump_choice:
menu:
    "Организовать срочную уборку силами города (2000$)" if budget >= 2000:
        $ budget -= 2000
        $ rating += 2
        "Житель" "Спасибо! Надеюсь, теперь порядок наведёте."
        hide citizen
        jump after_case3
    "Организовать срочную уборку силами города (2000$) [Недостаточно средств]" if budget < 2000:
        pass
    ...
    menu:
        "Выдать субсидию на фильтры (1000$)":
            if budget >= 1000:
                ...
                "Владелец автомойки" "У вас не хватает средств на фильтры."
