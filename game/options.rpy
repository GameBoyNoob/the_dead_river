...
define config.name = _("The Coffin OF Dead River")
...
define gui.about = _p("""
Альфа версия новеллы не предназначена для конечного пользователя код защищен лицензией GPL-V3 а голос музыка и рисунки CC BY-SA 4.0

Приятного тестирования)

Главный Художник и Дизайнер - Telleyn, автор спрайтов фонов и много другого большое спасибо)

Озвучка - Александр Хаев и Ольга Конон (Георгий и Анастасия), а также Министр (Дерновский Арсений)
...
define build.name = "TheDeadRiver"
...
define config.main_menu_music = "audio/ost/main.ogg"
...
define config.save_directory = "TheDeadRiver-1746647516"
